...
<head>
    ...
    <title>Bible Journey — Política de Privacidad / Privacy Policy</title>
    <style>
        body { font-family: -apple-system, system-ui, sans-serif; max-width: 760px; margin: 0 auto; padding: 2rem 1.25rem 4rem; line-height: 1.6; color: #1a1a1a; }
        h1 { font-size: 1.6rem; }
        h2 { font-size: 1.15rem; margin-top: 2.2rem; border-bottom: 1px solid #ddd; padding-bottom: .3rem; }
        section { margin-bottom: 1rem; }
        .lang-block + .lang-block { margin-top: 3.5rem; padding-top: 2rem; border-top: 3px solid #333; }
...
<section>
    <ul>
        ...
        <li><strong>Preferencias:</strong> idioma preferido, nivel de lectura y configuración de recordatorios.</li>
...
<section>
    <ul>
        <li>No mostramos publicidad ni usamos redes de anuncios.</li>
        <li>No usamos herramientas de analítica ni rastreo de terceros (no hay Google Analytics, Firebase Analytics, Meta Pixel, etc.).</li>
        <li>No vendemos ni compartimos tus datos personales con terceros con fines comerciales.</li>
    </ul>
</section>
...
<section>
    <ul>
        <li><strong>Account data:</strong> name, email address, and password (stored encrypted, never in plain text).</li>
        <li><strong>Preferences:</strong> preferred language, reading level, and reminder settings.</li>
...
<section>
    <ul>
        <li>We do not show ads or use ad networks.</li>
        <li>We do not use third-party analytics or tracking tools (no Google Analytics, Firebase Analytics, Meta Pixel, etc.).</li>
        <li>We do not sell or share your personal data with third parties for commercial purposes.</li>
    </ul>
</section>
